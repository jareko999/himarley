...
export const timelineSections: TimelineSectionData[] = [
  ...
  },
  {
    ...
    title: 'Woodworking',
    description: `I lived with my grandmother in Vermont during the summer of 2012 to help around the house after my grandfather was put in a nursing home. That's when I first started tinkering in his garage. I'd get driftwood from the Connecticut river, like he did, and created my first pieces of furniture.`,
  ...
  },
  {
    ...
    slug: '2018-gitlab',
    title: 'GitLab',
    description: `After just a couple years working in Boston, I got at GitLab. I started when we were "just" 300 people and left when we were 1,600. We went public in 2021 while I was there and got to go to New Orleans for our annual in-person event. I didn't however get to go to Prague or the Carribean because of COVID.`,
  ...
  },
  {
    ...
    description: `A buddy of mine was moving back home from Eugene, OR. I took a flight out and we started across the country the next day. We stopped at the Badlands in South Dakota, saw some real cowboys in Wyoming, and played golf in Ohio and Montana. All with his two massive dogs in the truck bed.`,
    images: ['1.JPG', '2.JPG', '3.JPG'],
  },
  {
    year: '2019',
  ...
  },
  {
    ...
    slug: '2022-lonebirch',
    title: 'Lone Birch',
    description: 'After leaving GitLab, I wanted to start my own business and wanted to start making things with my hands again. I loved the idea of launching a brand, so I created Lone Birch, where I made home office products out of my garage. Things started taking off after a few months and had a really successful first year.',
  ...
  },
  {
    ...
    slug: '2025-nara',
    title: 'Nara',
    description: `We welcomed the newest member of our team in 2025, Nara, named after the city in Japan. In the hospital room I couldn't believe my eyes when I looked at the rolling bassinet, whose brand name was "Nara". It was meant to be. I'm really grateful to have both a boy and a girl.`,
    images: ['1.png', '2.png', '3.png'],
  },
  {
    year: '2025-',
    ...
    description: `When Nara was born, I decided to stop working on Lone Birch and Distro to focus raising the kids. It's not always easy, but I know I'll never get this time back, so to be able to spend this much time with them this early in their life, is truly a blessing.`,
    images: ['1.png', '2.png', '3.png'],
  },
]
